export const enAccount = {
  ...
  overview: {
    ...
    flowLabel: "Reader flow",
    flowTitle: "How this account is meant to work",
    flowItems: [
      {
        index: "01",
        title: "Discover",
        text: "Browse gallery, authors and collections from the public side.",
      },
      {
        index: "02",
        title: "Unlock",
        text: "Use welcome unlocks, future purchases, membership benefits or AT Credits.",
      },
      {
        index: "03",
        title: "Read",
        text: "Return to online titles, downloads and reader settings from your library.",
      },
      {
        index: "04",
        title: "Participate",
        text: "Follow authors and send private signals through the editorial layer.",
      },
    ],
  },
  library: {
