export const enAccount = {
  ...
  profile: {
    kicker: "Profile",
    title: "Your ARTales identity",
    lede: "Edit the visible name and handle used by your reader account and future ARTales records.",
    errors: {
      missing: "Fill in your display name and handle.",
      handle: "Handle must have 3–30 characters and can contain only a-z, 0-9, dot, underscore or hyphen.",
      handleTaken: "This handle is already taken. Choose another one.",
      handleCheck: "ARTales could not check handle availability. Try again.",
      save: "Profile could not be saved. Try again.",
    },
    saveSuccess: "Profile saved.",
    displayName: "Display name",
    displayNameHelp: "Visible name. Spaces and diacritics are allowed.",
    handle: "Handle",
    handleHelp: "Unique identifier. Use a-z, 0-9, dot, underscore or hyphen. No spaces or diacritics.",
    save: "Save profile",
  },
  security: {
    kicker: "Account security",
    title: "Security",
    lede: "Change your password or request a reset e-mail. This is the single security area for reader, member, editor and admin accounts.",
    errors: {
      ...
      resetSend: "Password reset e-mail could not be sent. Try again later.",
    },
    success: {
      password: "Password was changed.",
      resetSent: "Password reset e-mail was sent. Check your inbox.",
    },
    changePassword: "Change password",
    signedInHelp: "You are already signed in, so you can set a new password directly.",
    newPassword: "New password",
    passwordHelp: "Password must have at least 8 characters.",
    confirmPassword: "Confirm new password",
    resetTitle: "Password reset e-mail",
    resetHelp: "Use this if you want a standard reset link sent to your account e-mail address. The link will bring you back to ARTales to set a new password.",
    sendReset: "Send reset e-mail",
  },
  settings: {
    kicker: "Reader settings",
    title: "Your reading defaults",
    lede: "Choose a calm Reader default. Open the details only when you need them.",
    ...
    simpleSettingsHelp: "Choose the theme and layout used when you open another text.",
    advancedSettings: "Advanced settings",
    advancedSettingsHelp: "You do not need to adjust typography for comfortable everyday reading.",
    localStorageNote: "Theme, width, density, and text size are also saved to your profile. Layout and advanced-control visibility currently apply only in this browser; cross-device sync is a future step.",
    ...
    layoutPagedFlow: "Paged flow",
    layoutSpread: "Two-page spread",
    ...
    fontScale: "Text size",
    showAdvancedControls: "Show advanced controls in the Reader",
    showAdvancedControlsHelp: "When enabled, text size, width, and line density appear in the compact Reader menu.",
