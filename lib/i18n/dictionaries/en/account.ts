export const enAccount = {
  ...
  creditUnlock: {
    kicker: "Unlock with AT Credit",
    title: "Unlock online reading",
    lede: "Confirm that you want to add this title to your library with AT Credit. After unlocking, the full reader opens.",
    selectedWorkLabel: "Selected title",
    unknownAuthor: "Unknown author",
    priceLabel: "Online reading price",
    creditUnit: "AT",
