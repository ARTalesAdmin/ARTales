export const csPublic = {
  ...
  homeEyebrow: "Galerie příběhů pro klidné čtení",
  homeTitle: "Objevujte literaturu jako galerii.",
  homeIntro:
    "ARTales otevírá vybraná díla v klidném online prostředí. Začněte ukázkou, procházejte kolekce a čtěte texty s jasným původem, autorem a kontextem.",
  homePrimaryCta: "Prozkoumat galerii",
  ...
  homeBrandNote:
    "Online prostor pro literaturu, která má být přehledná, čitelná a zasazená do souvislostí.",
  homeCardEditionsTitle: "Výběr místo nekonečného katalogu",
  homeCardEditionsText:
    "Galerie nemá být skladištěm textů. Každé dílo má být představené srozumitelně: autor, anotace, jazyk, stav a cesta ke čtení.",
  homeCardReaderTitle: "Reader, který ustupuje textu",
  homeCardReaderText:
    "Rozhraní má pomáhat orientaci a soustředění. Otevřete titul na počítači nebo telefonu a vraťte se k němu, když máte čas.",
  homeCardExpansionTitle: "Kolekce a souvislosti",
  homeCardExpansionText:
    "Díla propojujeme do čtenářských cest podle témat, atmosféry, autorů nebo období. Nejde jen o seznam titulů, ale o způsob objevování.",
  homeReaderEyebrow: "Jak číst v ARTales",
  homeReaderTitle: "Vyberte dílo, otevřete ukázku a pokračujte vlastním tempem.",
  homeReaderText:
    "Na ARTales můžete začít jednoduše: projít galerii, otevřít detail díla, přečíst ukázku a vracet se k textům, které vás zaujmou.",
  homeReaderTextSecondary:
    "Kolekce, anotace a ediční informace pomáhají číst s větším přehledem — ať hledáte známou klasiku, nový objev nebo souvislosti pro další čtení.",
  homePathAria: "Cesty do ARTales",
  homePathGalleryEyebrow: "Galerie",
  homePathGalleryTitle: "Najděte si dílo",
  homePathGalleryText:
    "Procházejte publikované tituly, otevřete detail a začněte číst ukázku nebo dostupný reader.",
  homePathGalleryCta: "Otevřít galerii",
  homePathCollectionsEyebrow: "Kolekce",
  homePathCollectionsTitle: "Objevujte souvislosti",
  homePathCollectionsText:
    "Kolekce vytvářejí čtenářské trasy napříč tématy, autory, žánry a atmosférami.",
  homePathCollectionsCta: "Procházet kolekce",
  homePathAccountEyebrow: "Účet",
  homePathAccountTitle: "Vraťte se ke čtení",
  homePathAccountText:
    "Účet pomáhá ukládat přístup k dílům a vracet se ke čtení z různých zařízení.",
  homePathAccountCta: "Zobrazit účet",
  homeFinalEyebrow: "Začněte číst",
  homeFinalTitle: "Otevřete galerii a vyberte si první dílo.",
  homeFinalText:
    "Začněte ukázkou, projděte kolekce nebo nám napište, které dílo, autor nebo téma by podle vás v ARTales nemělo chybět.",
  homeFinalPrimaryCta: "Vytvořit účet zdarma",
  homeFinalSecondaryCta: "Procházet díla",
  homeFinalContactCta: "Napsat ARTales",
  homeDevelopmentNote:
    "Náměty na tituly, opravy, spolupráci nebo čtenářské okruhy posílejte na [info@artales.net](mailto:info@artales.net).",
