...
Phase 4 polish adds visible page-margin markers, local selected-note feedback, previous/current/next navigation and a collapsible full list. Sync, storage, API and RLS are not changed by the polish.
