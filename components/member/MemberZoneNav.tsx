  ...
  return (
    <aside className="artales-member-sidebar">
      ...
      <nav className="artales-member-nav" aria-label="Členská navigace">
        {primaryLinks.map((item) => (
          <Link
            ...
            className={[
              ...
              isActivePath(pathname, item.href) ? "artales-member-nav__link--active" : "",
            ]
              .filter(Boolean)
              .join(" ")}
          >
        ...
        <div className="artales-member-nav__group">
          {creationLinks.map((item) => (
            <Link
              ...
              className={[
                "artales-member-nav__link",
                pathname === item.href ? "artales-member-nav__link--active" : "",
              ]
                .filter(Boolean)
                .join(" ")}
            >
        ...
        <div className="artales-member-nav__group">
          <Link className="artales-member-nav__link" href="/galerie">
