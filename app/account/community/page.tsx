  ...
  return (
    <section className="artales-account-page">
      ...
      <p className="artales-account-lede">
        ARTales community is not a public comment stream. It is a future participation layer where readers can follow
        authors, send useful signals, help with corrections or translations, join groups, learn, teach and gradually grow
        into contributor, member, editor or mentor roles.
      </p>
